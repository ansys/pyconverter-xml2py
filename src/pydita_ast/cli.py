...
def create_package(xml_path=None, functions_path=None, target_path=None):
    ...
    target_path: str, optional
        Directory where you want the autogenerated package to be created.
...
@package.command()
@click.option("-x", "--xml-path")
@click.option("-f", "--func-path")
@click.option("-t", "--targ-path")
def information(xml_path, func_path, targ_path):
    """Enter the information needed to generate your package."""
