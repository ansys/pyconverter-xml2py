...
class MAPDLCommand(Element):
    ...
    def __init__(
        ...
        base_url,
        fcache,
        autogenerated_folder_name=folder.autogenerated_folder_name,
        meta_only=False,
    ):
    ...
    def py_docstring(self):
        ...
        def arg_replacer(match):
            ...
            return f":func:`{func}({py_args}) <{self._autogenerated_folder_name}.{func}>` {tail}"
        ...
        def cmd_replacer(match):
            ...
            return f":func:`{func}() <{self._autogenerated_folder_name}.{func}>`"
